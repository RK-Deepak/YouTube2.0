...
const VoiceSearch = ({ setIsListening, isListening }) => {
  ...
  return (
    ...
    >
      <div className="absolute top-[24%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[300px] w-[80%] bg-white flex justify-center items-center z-50   flex-col gap-2">
        <div className="p-2 listeningeffect  ">
          <IoMicCircleOutline className="font-sans text-[100px] cursor-pointer" />
          <GiSplitCross
            className="absolute top-4 right-4 text-2xl"
            onClick={closevoicerecognition}
          />
        </div>
